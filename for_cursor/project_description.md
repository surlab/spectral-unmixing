...
Subpanel 7 orerlapping histogram of angles between all the pixels and each of the vectors (n subplots vertically I think. ) if labels are known color the portion of the bar by the appropriate flourophore. see figure 5.5 and figure 1.8


Subpanel 8 - agreement of pixel classifications across independant subsets
different subsets are - 
subset 1 excitation based - all 20mW broad
subset 2 dual domaian - best row dict
subset 3 emission based - 1080 +orange, red, far red (emission based)
subset 4 dual domain 2 - 800nm red, far red, 1040 red, far red
8.0 table highlighting the channel subsets. will be similar to fig 1 subpanel 3 except for all the channels here and the highlight color is based on grouping, not FP. lets use shades of blue to avoid confusion - use the same shades of blue as figure 1 for excitation based, emission based and dual domain. you will have to add a new color for dual domain 2 no need to label the cells with channel numbers
8.1
