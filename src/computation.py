...
def correct_PMT_nonlinearity(photons_measured_to_correct, detected_photons_list, true_photons_list):
    ...
    detected_dense = np.linspace(detected_photons_list[idx-1], detected_photons_list[idx], 10**cfg.resolution)
    true_dense = np.linspace(true_photons_list[idx-1], true_photons_list[idx], 10**cfg.resolution)
